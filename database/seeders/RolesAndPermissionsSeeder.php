...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $perms = [
            ...
            // >>> CIRUGÍAS (nuevo bloque)
            'surgery.view','surgery.create','surgery.update',
            'surgery.delete','surgery.restore','surgery.forceDelete',
            // <<< fin cirugías
        ];
        ...
        // Doctor: igual que recetas — ver/crear/actualizar (sin delete/restore/forceDelete)
        ...
        // Recepcionista: sin permisos de recetas/cirugías (como ya estaba)
